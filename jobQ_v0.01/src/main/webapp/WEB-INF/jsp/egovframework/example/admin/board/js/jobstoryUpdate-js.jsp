...
<script>
	...
	$('#jobstoryUpdateBtn').on('click', function(){
		location.href="<c:url value='/admin/board/jobstory/update.jobq?no=" + ${no} + "' />";
	});
	...
	$('#jobstoryListBtn').on('click', function(){
		location.href="<c:url value='/admin/board/jobstory/main.jobq' />";
	})
	...
	$('#jobstoryUpdateCancelBtn').on('click', function(){
		history.back();
	})
