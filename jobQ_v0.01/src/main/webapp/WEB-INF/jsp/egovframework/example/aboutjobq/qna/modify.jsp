					...
					<div class="row">
						...
						<div class="col-lg-12 col-md-12 col-sm-12">
							<div class="storyWrap">
								...
								<form name="qnaModifyFrm" id="qnaModifyFrm">
										...
										<tbody>
											<tr>
												...
												<td><input type="text" class="form-control" id="qnaTitle"
													maxlength= "50" placeholder="제목을 입력하세요!" name="qnaTitle"
													value="<c:out value="${qnaDetail['0'].qTitle}" />"></td>
											</tr>
											<!-- <tr>
							...
							<div class="col-sm-12 mrgb-30 btnArea">
								...
								<a href="#" onclick="javascript:qnaModify.pageSubmitFn('modifyQ')"
									class="btn btn-sm btn-social-linkedin"> <i
									class="fa fa-check"></i> 수정
								</a> 
								<a href="#"
									onclick="javascript:left.pageSubmitFn('goQnAList')"
...
$(document).ready(function(){
	var value = "${qnaDetail['0'].qContent}";
	$("#qnaContent").val(value.replace(/<br>/g, "\n"));
});
/* 글자수 세기 */
...
var qnaModify = {
		...
		pageSubmitFn : function(pageName){
			if($("#qnaTitle").val() == ''){
				...
				$("#qnaModifyFrm").attr("action", pageName + ".jobq");	
			
				$("#qnaModifyFrm").attr("method", "post");
