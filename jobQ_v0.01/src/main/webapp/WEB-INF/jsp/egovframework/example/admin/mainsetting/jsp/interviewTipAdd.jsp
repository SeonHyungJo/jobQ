	...
	<div class="page-head">
		...
		<div class="bread-crumb pull-right" style="text-align: right;">
			<a href="<c:url value="/admin/main.jobq" />">
				...
				<span>메인 관리&nbsp;-&nbsp;면접 Tip 관리&nbsp;-&nbsp;<strong style="font-size: 18px;">면접 Tip 추가</strong></span>
		</div>
			...
			<div class="widget">
								...
								<tr>
									...
									<td width="35%">
										<div class="form-group" style="margin: 0px; width: 60%; display: inline-block;">
											<input type="email" class="form-control" value="${sessionScope.login.id}" readOnly/>
										</div>
									</td>
									...
									<td width="35%">
										<div class="form-group" style="margin: 0px; width: 60%; display: inline-block;">
											<input type="date" id="interview-reg-date" class="form-control" readOnly/>
										</div>
									</td>
								</tr>
								...
								<tr>
									<td colspan="4" style="border: solid 1px rgb(221, 221, 221);">
										<div class="form-group" style="margin: 0px;">
											<textarea name="contentEditor" id="interview-editor" rows="10" style="width : 100%;">
											</textarea>
										</div>
									</td>
								</tr>
				...
				<div class="widget-foot" style="text-align: center; padding: 4px 0px; background-color: #ffffff; border: 0px;">
					<div class="padd" style="padding-top:0px;">
						<button type="button" class="btn btn-default" id="interview-regist-btn">등록</button>
						<button type="button" class="btn btn-default" id="interview-regist-cancle-btn">취소</button>
					</div>
				</div>
			</div>
