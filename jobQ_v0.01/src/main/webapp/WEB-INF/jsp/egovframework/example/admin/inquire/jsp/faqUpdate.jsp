	...
	<div class="page-head">
		...
		<div class="bread-crumb pull-right" style="text-align: right;">
			<a href="<c:url value="/admin/main.jobq" />"><i
				...
				A Q&nbsp;-&nbsp;<strong style="font-size: 18px;">F A Q 수정</strong>
			</span>
		</div>
			...
			<div class="widget">
							...
							<table class="table"
								...
								<tr>
									...
									<td width="35%">
										<div class="form-group"
											style="margin: 0px; width: 60%; display: inline-block;">
											<input type="email" class="form-control" value="dbsdy1235@xxxxxxx.com" />
										</div>
									</td>
								</tr>
								<tr>
									...
									<td width="35%">
										<div class="form-group"
											style="margin: 0px; width: 60%; display: inline-block;">
											<input type="date" class="form-control" value="2017-07-27" />
										</div>
									</td>
								...
								<tr>
									...
									<td width="35%" colspan="3"
										...
										<div class="form-group"
											...
											<input type="text" class="form-control" value="IP보안 사용방법이 어떻게 되나요?" />
										</div>
									</td>
								</tr>
							</table>
								...
								<tr>
									<td colspan="4" style="border: solid 1px rgb(221, 221, 221);">
										<div class="form-group" style="margin: 0px;">
											<textarea name="contentEditor" id="contentEditor" rows="10" cols="80">
				...
				<div class="widget-foot"
					...
					<div class="padd" style="padding-top:0px;">
						<button type="button" class="btn" id="faqUpdateBtn">수정</button>
