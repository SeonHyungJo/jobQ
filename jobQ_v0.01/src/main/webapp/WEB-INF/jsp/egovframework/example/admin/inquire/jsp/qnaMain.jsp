							...
							<table class="table" style="border: solid 1px rgb(221, 221, 221); border-collapse: collapse;">
								<tr>
									...
									<td width="85%">
										...
										<input type="button" class="btn btn-default" id="qna-search-btn" value="검색" />
									</td>
								</tr>
							</table>
						</form>
				...
				<div class="col-md-12">
					<div class="widget">
						<div class="widget-content" style="border:0px;">
							<div class="padd">
								<table id="qna-table" class="row-border hover stripe" style="width:100%"></table>
							</div>
						</div>
					</div>
				</div>
